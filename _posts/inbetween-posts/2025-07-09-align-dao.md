...
categories:
    - economic
description: "An Engineering Approach to Building Aligned Organizations. In this post, I argued that our society is facing two alignment problems, not one."
---
...
If we cannot trust a modern corporation—an entity whose legal structure often compels it to prioritize profit above all else[^1]—to not harm society, how can we possibly trust it to build a safe and beneficial Artificial General Intelligence? The premise is absurd.
