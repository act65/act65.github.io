...
> "If this guy opened a funeral parlour, nobody would die. He can screw up anything—"
> — David Seymour ([Hansard, 10 Mar 2026](https://hansard.parliament.nz/hansard-transcript/2026-03-10))

And here is another minister, asked in the House to explain what systemic bias is:

> "Well, systemic bias is bias that's systemic."
> — Mark Mitchell ([Hansard, 29 Aug 2024](https://hansard.parliament.nz/hansard-transcript/2024-08-29))
...
[**NZ Politician Scorecards**](https://nz-politician-scorecards.onrender.com/) gives every MP a trading card. Nine attributes, scored 0–100, all oriented so higher is better, all measuring conduct rather than policy:

<ul style="list-style:none; padding-left:0; margin:1.2rem 0;">
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="12" x2="16" y2="12"/><polyline points="12 8 16 12 12 16"/><circle cx="20" cy="12" r="1.7"/></svg><span><strong>Forthrightness</strong> — do they answer the question actually asked?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 L13.6 5 V14 H10.4 V5 Z"/><line x1="8" y1="15" x2="16" y2="15"/><line x1="12" y1="15" x2="12" y2="20"/><circle cx="12" cy="21.2" r="1.2" fill="currentColor" stroke="none"/></svg><span><strong>Strength</strong> — do promises turn into implemented policy?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3 L19 6 V12 C19 16 16 19 12 21 C8 19 5 16 5 12 V6 Z"/><polyline points="9 12 11 14 15 9"/></svg><span><strong>Veracity</strong> — do their factual claims hold up?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 7 C3.5 5 8.5 5 8.5 7 C8.5 12 7 15 6 15 C5 15 3.5 12 3.5 7 Z"/><circle cx="5" cy="8.6" r="0.5" fill="currentColor" stroke="none"/><circle cx="7" cy="8.6" r="0.5" fill="currentColor" stroke="none"/><path d="M5 11 C5.6 12.2 6.4 12.2 7 11"/><path d="M15.5 9 C15.5 7 20.5 7 20.5 9 C20.5 14 19 17 18 17 C17 17 15.5 14 15.5 9 Z"/><circle cx="17" cy="10.6" r="0.5" fill="currentColor" stroke="none"/><circle cx="19" cy="10.6" r="0.5" fill="currentColor" stroke="none"/><path d="M17 14.6 C17.6 13.4 18.4 13.4 19 14.6"/></svg><span><strong>Authenticity</strong> — do their words in the House match their words outside it?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="9.5" r="5.5"/><path d="M12 7 L12.8 9 L14.8 9.8 L12.8 10.6 L12 12.6 L11.2 10.6 L9.2 9.8 L11.2 9 Z" fill="currentColor" stroke="none"/><path d="M8 16.5 H16 M9.5 16.5 L8.6 20 H15.4 L14.5 16.5"/></svg><span><strong>Divination</strong> — are their predictions specific enough to be checked, and plausible on the evidence at the time?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 C12 6 16 8.5 16 13 A4 4 0 0 1 8 13 C8 9.5 10.5 8.5 11 5 C11.6 6.6 12.8 7 13 8.5 C13.6 7 13 4 12 2 Z"/><path d="M12 11 C12 12.5 13.2 13 13.2 14.4 A1.4 1.4 0 0 1 10.4 14.4 C10.4 13 11.4 12.6 12 11 Z" fill="currentColor" stroke="none"/></svg><span><strong>Charisma</strong> — can they persuade across the aisle?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M5 20 C8 16 11 11 13 4"/><path d="M13 4 C15.5 4.2 16.2 6.6 14.8 8 C12.7 7.8 12 5.2 13 4 Z"/><path d="M11.4 8.6 C13.9 8.8 14.6 11.2 13.2 12.6 C11.1 12.4 10.4 9.8 11.4 8.6 Z"/><path d="M9.4 13.2 C11.9 13.4 12.6 15.8 11.2 17.2 C9.1 17 8.4 14.4 9.4 13.2 Z"/></svg><span><strong>Civility</strong> — attacking the argument, or the person?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="4" x2="12" y2="20"/><line x1="4" y1="7" x2="20" y2="7"/><circle cx="12" cy="5.4" r="1" fill="currentColor" stroke="none"/><line x1="8" y1="20" x2="16" y2="20"/><path d="M1.5 8 C1.5 11 6.5 11 6.5 8"/><path d="M17.5 8 C17.5 11 22.5 11 22.5 8"/><line x1="4" y1="7" x2="4" y2="8"/><line x1="20" y1="7" x2="20" y2="8"/></svg><span><strong>Rigor</strong> — evidence and valid inference, or fallacy?</span></li>
  <li style="display:flex; gap:0.7rem; align-items:flex-start; margin:0.5rem 0;"><svg width="22" height="22" aria-hidden="true" style="flex:none; margin-top:0.16em;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4.8"/><circle cx="12" cy="12" r="1.5" fill="currentColor" stroke="none"/></svg><span><strong>Specificity</strong> — is there content in the sentence, or is it a platitude?</span></li>
</ul>
...
<div style="display:flex; gap:2rem; justify-content:center; flex-wrap:wrap; margin:2rem 0;">
  <img src="{{site.baseurl}}/assets/scorecards/card-top.png" alt="Scorecard for Adrian Rurawhe" style="width:240px; max-width:45%;">
  <img src="{{site.baseurl}}/assets/scorecards/card-bottom.png" alt="Scorecard for Winston Peters" style="width:240px; max-width:45%;">
</div>
...
> "We are confident we will have effective legislation that will deliver good outcomes."
> — Casey Costello, NZ First ([Hansard, 27 Feb 2024](https://hansard.parliament.nz/hansard-transcript/2024-02-27))
...
> "I may make a few remarks about a dolphin that doesn't exist, otherwise known as the Māui dolphin. It was a contrivance, a fiction, put together by some underemployed academic down in the South Island."
> — Shane Jones, NZ First ([Hansard, 11 Feb 2025](https://hansard.parliament.nz/hansard-transcript/2025-02-11))
...
> "The only thing most of them seem to be experienced at is being a bunch of Communists – they openly admit it."
> — Winston Peters, NZ First ([party press release, 28 Mar 2026](https://www.nzfirst.nz/winston_peters_true_party_of_the_workers))

**Civility — 5/100.** A jibe at another member's mental capacity, mid-answer:

> "And for the member who has just sprung into life—although perhaps not mentally—"
> — David Seymour, ACT ([Hansard, 20 Aug 2025](https://hansard.parliament.nz/hansard-transcript/2025-08-20))
...
> "It's a good bill, and I'm sure everyone in the House will support it—I certainly do."
> — Duncan Webb, Labour ([Hansard, 30 Jul 2025](https://hansard.parliament.nz/hansard-transcript/2025-07-30))
...
> "civility in politics and the ability for New Zealanders to talk to each other and to push back against that global direction of division and polarisation is an important part not only of our democracy but of how we succeed as a country."
> — Paul Goldsmith, National ([Hansard, 8 Oct 2025](https://hansard.parliament.nz/hansard-transcript/2025-10-08))
...
The interesting cases are the ones where something *is* contested and it happens anyway. Chris Bishop, mid-argument, at 95: *"the member does make a good point around funding pressure on the National Land Transport Fund. That is true."* ([Hansard, 8 Apr 2025](https://hansard.parliament.nz/hansard-transcript/2025-04-08)) Vanushi Walters — the top-ranked card — at 90, telling the other side *"I do acknowledge to the members opposite that there are times when you do need to limit the right to freedom of expression."* ([Hansard, 21 Aug 2025](https://hansard.parliament.nz/hansard-transcript/2025-08-21)) Ginny Andersen, at 90 on the same day, granting that *"demonstrations outside people's homes can cross the line, and there are times when they can be deeply intrusive to families"* ([Hansard, 21 Aug 2025](https://hansard.parliament.nz/hansard-transcript/2025-08-21)). None of these cost anything except the momentary pleasure of not conceding.
...
> "what you Sim City obsessed planning nerds believe should be the right number of houses, Tamatha Paul"
> — Simon Court, ACT ([Hansard, 31 Mar 2026](https://hansard.parliament.nz/hansard-transcript/2026-03-31))
...
> — Chris Bishop, National ([speech to the AA annual conference, 27 Mar 2026](https://www.national.org.nz/news/20260327-hon-chris-bishop-speech-to-aa-annual-conference))

And from the other side of the House, correcting a misused number with the source attached:

> "The Prime Minister's statements where he talks about 'people on the youth benefit are now languishing on welfare for an average of 24 years' — that's also not backed up by the Taylor Fry report; that's a forecast."
> — Ricardo Menéndez March, Green ([Hansard, 1 May 2024](https://hansard.parliament.nz/hansard-transcript/2024-05-01))
...
**Have a look:** [nz-politician-scorecards.onrender.com](https://nz-politician-scorecards.onrender.com/) — cards on the front page, [the dataset](https://nz-politician-scorecards.onrender.com/data) for full stats and downloads, [about](https://nz-politician-scorecards.onrender.com/about) for method and caveats. It's on free hosting, so the first visit after a quiet period takes a few seconds to wake up.
...
- New sections added on attribute correlation, rubric framing, and [why the comparison isn't fair yet](#the-comparison-isnt-fair-yet). Ranks in the bottom of the table are now given as a band rather than exact places.

The site's [about page](https://nz-politician-scorecards.onrender.com/about) carried the same stale validation claim and has been corrected too.
