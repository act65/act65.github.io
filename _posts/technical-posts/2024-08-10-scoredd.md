...
description: "Diffusion is just stacked denoising score matching. Our goal is to approximate a data distribution p(x) with a model p_{\\theta}(x) using a set of samples..."
---
