...
description: "MAP produces solutions that are not typical. We solve an inverse problem with MAP vs PITS. Here we pick the prior and likelihood to be Gaussian..."
tags:
  - research
  - probability
  - information-theory
